...
extern void mount_sd_start(void);
STATIC MP_DEFINE_CONST_FUN_OBJ_0(machine_sdcard_reset_obj, mount_sd_start);
...
STATIC const mp_rom_map_elem_t machine_sdcard_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_reset), MP_ROM_PTR(&machine_sdcard_reset_obj) }
};
