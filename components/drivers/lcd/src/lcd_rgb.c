...
static rgb_lcd_ctl_t lcd_para_4p3 = {
	...
	.hbp = 43,  .w = 480/4, .hfp = 12,
    .vbp = 4,  .h = 272/4, .vfp = 12,
	.enable=0, .div_xy = 0,.div_pos = 640/4,
	.mula_M=1, .mula_N = 1,
	.mulb_M=1, .mulb_N = 1,
	.phase_de=1, .phase_vsync=1, .phase_hsync=1, .phase_pclk=0,
	.refresh_time = 23, .spi_speed = 80 * 1000 * 1000};
...
static rgb_lcd_ctl_t lcd_para_5p0_ips = {
	...
	.mula_M=1, .mula_N = 2, //2倍缩放
	.mulb_M=1, .mulb_N = 1, //不缩放
	.phase_de=1, .phase_vsync=1, .phase_hsync=1, .phase_pclk=0,
	.refresh_time = 25, .spi_speed = 80 * 1000 * 1000};

static rgb_lcd_ctl_t lcd_para_5p0_7p0 = {
.width = 800, .height = 480,
.vbp = 0,  .h = 480/4, .vfp = 0, 
.hbp =180, .w = 800/4, .hfp = 0, 
.enable=1, .div_xy = 0,.div_pos = 800/4, //x方向分割到800
.mula_M=1, .mula_N = 2, //2倍缩放 
.mulb_M=1, .mulb_N = 1, //不缩放 
.phase_de=1, .phase_vsync=1, .phase_hsync=1, .phase_pclk=1, 
.refresh_time = 28, .spi_speed = 80 * 1000 * 1000};
...
static void rgb_lcd_set_freq(uint32_t freq){ // freq : hz 为单位
...
static inline void rgb_lcd_draw_point_rgb(uint16_t x, uint16_t y, uint16_t color)
{
    ...
    ((uint16_t *)lcd_main)[(y*sipeed_lcd_w) + x] = invert ? ~color : color;
}
...
{	
    ...
    uint16_t x_end = x1 + width, y_end = y1 + height;
