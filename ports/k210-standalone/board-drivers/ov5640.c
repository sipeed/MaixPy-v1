...
uint8_t myov5640_init(void)
{
	...
	delay(100);
	for (uint16_t i = 0; ov5640_config[i][0] != 0; i++)
		dvp_sccb_send_data(OV5640_ADDR, ov5640_config[i][0], ov5640_config[i][1]);
...
{
        return (dvp_sccb_receive_data(OV5640_ADDR, 0x300A) << 8) | dvp_sccb_receive_data(OV5640_ADDR, 0x300B);
}
