...
STATIC const mp_rom_map_elem_t Maix_i2s_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_NO_CLOCK_GATING), MP_ROM_INT(NO_CLOCK_GATING) },
    { MP_ROM_QSTR(MP_QSTR_CLOCK_CYCLES_12), MP_ROM_INT(CLOCK_CYCLES_12) },
    { MP_ROM_QSTR(MP_QSTR_CLOCK_CYCLES_16), MP_ROM_INT(CLOCK_CYCLES_16) },
    { MP_ROM_QSTR(MP_QSTR_CLOCK_CYCLES_20), MP_ROM_INT(CLOCK_CYCLES_20) },
    { MP_ROM_QSTR(MP_QSTR_CLOCK_CYCLES_24), MP_ROM_INT(CLOCK_CYCLES_24) },
